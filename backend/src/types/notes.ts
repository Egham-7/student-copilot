...
export type NoteToKnowledgeArtifact = typeof notesToKnowledgeArtifacts.$inferSelect;
export type NewNoteToKnowledgeArtifact = typeof notesToKnowledgeArtifacts.$inferInsert;
